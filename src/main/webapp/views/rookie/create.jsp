...
<spring:message code="rookie.terms" var="terms" />
<spring:message code="rookie.acceptedTerms" var="acceptedTerms" />
<spring:message code="rookie.secondPassword" var="secondPassword" />
<spring:message code="cvv.ph" var="cvvPH" />
<spring:message code="month.ph" var="monthPH" />
<spring:message code="year.ph" var="yearPH" />


<security:authorize access="isAnonymous() or hasRole('rookie')">
