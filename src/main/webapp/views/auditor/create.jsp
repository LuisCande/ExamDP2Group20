...
<spring:message code="auditor.terms" var="terms" />
<spring:message code="auditor.acceptedTerms" var="acceptedTerms" />
<spring:message code="auditor.secondPassword" var="secondPassword" />
