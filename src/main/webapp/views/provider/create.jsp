...
<spring:message code="provider.terms" var="terms" />
<spring:message code="provider.acceptedTerms" var="acceptedTerms" />
<spring:message code="provider.secondPassword" var="secondPassword" />
